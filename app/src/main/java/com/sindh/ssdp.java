...
public class ssdp extends AppCompatActivity {
    Button call,wapp,email,web;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ssdp);
        call=findViewById(R.id.call);
        wapp=findViewById(R.id.wapp);
        email=findViewById(R.id.email);
        web=findViewById(R.id.web);
        Bitmap bitmap = BitmapFactory.decodeResource(this.getResources(),R.drawable.ssdp);
        ...
        wapp.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://api.whatsapp.com/send?phone=+17323975455&text=&source=&data="));
                startActivity(i);
            }
        });
        ...
        email.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                String mailto = "mailto:chairman@ssdpglobal.org";
        ...
        web.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.ssdpglobal.org/"));
                startActivity(i);
            }
        });
    }
