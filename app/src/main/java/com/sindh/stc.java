...
public class stc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wapp.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://api.whatsapp.com/send?phone=+923337007547&text=&source=&data="));
                startActivity(i);
            }
        });
        ...
        email.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                String mailto = "mailto:mujahidhussainsyed@gmail.com";
        ...
        web.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/mujahidsehwani"));
                startActivity(i);
            }
        });
    }
