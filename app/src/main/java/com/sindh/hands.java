...
public class hands extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wapp.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://api.whatsapp.com/send?phone=+923468209561&text=&source=&data="));
                startActivity(i);
            }
        });
        ...
        email.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                String mailto = "mailto:raheem.marri@hands.org.pk";
        ...
        web.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://handspakistan.wordpress.com/"));
                startActivity(i);
            }
        });
    }
