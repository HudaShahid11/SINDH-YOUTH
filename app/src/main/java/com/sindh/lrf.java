...
public class lrf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wapp.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://api.whatsapp.com/send?phone=+923006846828&text=&source=&data="));
                startActivity(i);
            }
        });
        ...
        email.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                String mailto = "mailto:tahir@lrfpk.org";
        ...
        web.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("http://lrfpk.org/"));
                startActivity(i);
            }
        });
        fb.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/lrfpk/"));
                startActivity(i);
            }
        });
    }
